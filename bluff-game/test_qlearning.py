...
def play_bluff_game(num_players=2, episodes=100):
    # Initialize agents
    agent_0 = QLearningAgent(learning_rate=0.1, discount_factor=0, epsilon=0.1)  # removed discount
    agent_1 = QLearningAgent(learning_rate=0.1, discount_factor=0, epsilon=0.1)  # removed discount
...
if __name__ == "__main__":
    agent1, agent2, wins_0, wins_1 = play_bluff_game(num_players=2, episodes=100)
    print("\nFinal Results:")
