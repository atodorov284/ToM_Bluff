...
ALL_ACTIONS = [ACTION_CHALLENGE, ACTION_PLAY_1, ACTION_PLAY_2, ACTION_PLAY_3, ACTION_PLAY_4]
...
class BluffEnv(AECEnv):
    ...
    def __init__(self, num_players: int = 2, render_mode=None) -> None:
        ...
        self._action_spaces = {agent: Discrete(len(ALL_ACTIONS)) for agent in self.possible_agents}  # Play or challenge
